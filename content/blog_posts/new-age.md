---
title: AI 时代中，我们应该把时间和精力花在哪里？
toc: false
mathjax: false
date: 2026-04-09 08:34:07
updated: 2026-04-09 13:34:36
slug: new-age
excerpt: 工具在以周为单位不断迭代更新，整个社会被彻底重构。我们如何保证自己的创造不过期？如何去抓住不变的东西？我们到底要做什么？
summary: "文章从印刷术、电力等历史类比出发，指出 AI 并非昙花一现，而是重塑学术生产和软件工程的底层范式：代码与实验将趋近零成本、由 Agent 自主完成，人类应从“怎么做”抽身，转向设计环境、设定目标与评价标准，重新追问学科与商业的第一性原理。"
tags:
- AI
- 随笔
---
...
这些思考，都从我读到[坏了，我成AI的乙方了！Anthropic论文爆火，谁还敢无脑Copy？](https://mp.weixin.qq.com/s/9oEDvdwi7z27G0xbFMyiVw)开始。
...
[当我们站在变革的开端 | Jiayuan (JY) Zhang](https://x.com/jiayuan_jy/status/2029851505583607961?s=46) 这篇文章，则提出了几乎完全相反的观点。
...
后来我又读到了[Claude Code 之父：AI 的改变不止于代码，程序员需要改变整个工作流](https://mp.weixin.qq.com/s/N0YUgGlvcVP6w9KbSYibgQ)，以及它对应的原视频 [Building Claude Code with Boris Cherny](https://youtu.be/julbw1JuAz0)。这篇访谈讲的是，在一个工程师不再亲自写代码的时代，要怎么完成一个复杂系统的构建。
...
与之相对，我又看到了 Anthropic 的技术博客 [Scaling Managed Agents: Decoupling the brain from the hands](https://www.anthropic.com/engineering/managed-agents)。它来自于宝玉的翻译，也给了我很大的触动。它大概的意思就是说，随着模型能力的更迭，在本地写 Harness Engineering 其实已经意义不大了，因为自己针对模型性质而做的一系列优化，在新的模型上线之后可能就已经不再需要了。它这个平台实际上完全是一个沙箱，是对所有想做 Agent 生态的人的降维打击。
...
这个思考的转变，是在我读完[去他的Harness | AI最严厉的父亲](https://x.com/dashen_wang/status/2041791096653820000?s=46)之后进一步成形的。
...
1. 与人进行连接，去满足人的需求
2. 尽可能地维系共同体，去找到志同道合的人
3. 发展自己跨学科进行能力迁移的技能

于是我来到了本文的最后一个引用来源，即吴恩达给斯坦福大学学生提供的职业建议，也就是这段演讲：[Stanford CS230 | Autumn 2025 | Lecture 9: Career Advice in AI](https://www.youtube.com/watch?v=AuZoDsNmG_s)。
