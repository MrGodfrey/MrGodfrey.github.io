<?php
	...
	$locale = array(
		...
		'zh' => array(
			'comment_form'	=> '评论写在这儿（其他填空可选）',
			'reply_form'	=> '回复写在这儿（其他填空可选）',
			'post_button'	=> '评论',
			'del_note'	=> '这条评论已被删除',
			'cmt_deleted'	=> '评论删除!',
			'options'	=> '选项',
			'cancel'	=> '取消',
			'reply_to_cmt'	=> '回复以评论',
			'edit_your_cmt'	=> '编辑你的评论',
			'nickname_tip'	=> 'Nickname or Twitter @username',
			'nickname'	=> 'Nickname or @user',
			'password_tip'	=> '密码 (只会用于之后修改或删除评论)',
			'password'	=> '密码',
			'email'		=> 'E-mail 地址',
			'website'	=> '网站',
			'logged_in'	=> '您已成功登录!',
			'cmt_needed'	=> '您没有输入正确的格式，请参看下方格式。',
			'reply_needed'	=> '您没有输入正确的格式，请参看下方格式。',
			'post_fail'	=> '无法评论，您没有权限。',
			'cmt_tip'	=> 'Accepted HTML: &lt;b&gt;, &lt;u&gt;, &lt;i&gt;, &lt;s&gt;, &lt;pre&gt;, &lt;ul&gt;, &lt;ol&gt;, &lt;li&gt;, &lt;blockquote&gt;, &lt;code&gt; escapes HTML, URLs automagically become links, and [img]URL here[/img] will display an external image.',
			'post_reply'	=> '回复',
			'delete'	=> '删除',
			'subscribe_tip'	=> '发送电子邮件通知',
			'subscribe'	=> '发送',
			'edit_cmt'	=> '编辑评论',
			'save_edit'	=> '保存编辑',
			...
			'like_cmt'	=> '\'赞\' 这条评论',
			'liked_cmt'	=> '你 \'赞\' 了这条评论',
			'op_cmt_note'	=> '您将不会收到邮件通知',
			'subbed_note'	=> '将被邮件通知',
			'unsubbed_note' => '将不会发送邮件通知'
		),
